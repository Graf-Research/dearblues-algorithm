...
var ForceDirectedFruchtermanReingold = /** @class */ (function () {
    ...
    ForceDirectedFruchtermanReingold.prototype.initializePointsPosition = function () {
        var _this = this;
        this.points = this.list_vertex.map(function () { return new Point({ x: Math.random() * _this.ideal_length, y: Math.random() * _this.ideal_length }); });
...
export { ForceDirectedFruchtermanReingold };
