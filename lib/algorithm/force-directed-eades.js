...
exports.ForceDirectedEades = void 0;
...
var ForceDirectedEades = /** @class */ (function () {
    ...
    ForceDirectedEades.prototype.initializePointsPosition = function () {
        var _this = this;
        this.points = this.list_vertex.map(function (v, i) { return new point_1.Point({ x: Math.random() * _this.ideal_length / 10, y: Math.random() * _this.ideal_length / 10 }); });
        this.defineAdjacencyMatrix();
    };
    ...
    ForceDirectedEades.prototype.baryCenter = function () {
        ...
        return this.points.reduce(function (acc, curr) { return acc.add(curr); }, point_1.Point.zero()).divide(this.list_vertex.length);
    };
    ForceDirectedEades.prototype.repulsiveForce = function (index_u, index_v) {
        ...
        return point_1.Point.unitVector(p_u, p_v).multiply(this.repulsion_constant / Math.pow(point_1.Point.euclideanDistance(p_v, p_u), 2));
    };
    ForceDirectedEades.prototype.attractiveForce = function (index_u, index_v) {
        ...
        var p_u = this.points[index_u];
        var p_v = this.points[index_v];
        return point_1.Point.unitVector(p_v, p_u).multiply(this.spring_constant * Math.log(point_1.Point.euclideanDistance(p_v, p_u) / this.ideal_length));
    };
    ForceDirectedEades.prototype.gravityForce = function (p_v, p_bary) {
        ...
        return point_1.Point.unitVector(p_v, p_bary).multiply(this.gravity_constant).multiply(mass);
    };
    ...
    ForceDirectedEades.prototype.iterate = function () {
        while (point_1.Point.euclideanDistance(point_1.Point.zero(), this.latest_max_force) > this.euclidean_threeshold && this.iteration < this.max_iteration) {
            ...
            for (var u = 0; u < this.points.length; u++) {
                force_list[u] = point_1.Point.zero();
            }
...
exports.ForceDirectedEades = ForceDirectedEades;
