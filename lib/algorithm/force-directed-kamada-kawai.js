...
exports.ForceDirectedKamadaKawai = void 0;
...
var ForceDirectedKamadaKawai = /** @class */ (function () {
    ...
    ForceDirectedKamadaKawai.prototype.initialize = function () {
        var _this = this;
        this.points = this.list_vertex.map(function () { return new point_1.Point({ x: Math.random() * _this.L0, y: Math.random() * _this.L0 }); });
    ...
    ForceDirectedKamadaKawai.prototype.initializeSpringMatrix = function () {
        ...
        var fm = new floyd_warshall_1.FloydWarshall(this.list_vertex, this.points, this.adjacency_matrix);
...
exports.ForceDirectedKamadaKawai = ForceDirectedKamadaKawai;
